        ...
        <div class="detailsBody">
           ...
           <p class="logos">
            ...
            <div class="father">
                ...
                <ul>
                    <li>
                        <img src="../../assets/wechat-auth-1.png" alt="">
                        <p>
                            确保您是公众号管理员
                        </p>
                    </li>
                    <li>
                        <img src="../../assets/wechat-auth-2.png" alt="">
                        <p>跳转到微信页面后使用您的微信扫一扫</p>
                    </li>
                    <li>
                        <img src="../../assets/wechat-auth-3.png" alt="">
                        <p>勾选授权清单请尽量全部选择</p>
                    </li>
                    <li>
                        <img src="../../assets/wechat-auth-4.png" alt="">
                        <p>授权完成后微信会跳回此页面继续</p>
                    </li>
                </ul>
            </div>
