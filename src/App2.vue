    ...
    <div>
        <div id="form" class="text-center">
            <div id="errorHint" :class="errorText != ''? 'errorHint':'noErrorHint'">
                ...
                <p>{{errorText}}</p>
                <button @touchstart="cancelError">确定</button>
            </div>
        ...
        methods:{
            ...
            submit(){
                if(this.input == ''){
                    ...
                    this.$http({
                        url: "http://open.izhuiyou.com/wechat/view/submit/"+this.$route.path.split('/')[this.$route.path.split('/').length-1],
                        method: 'POST',
                        body:{
...
//            const config = document.querySelector('title').getAttribute('data-json');
            const config = {
                appid: "wx653d39223641bea7",
                nonceStr:"b9b208b8-3069-4985-9803-30ef1f125902",
                signature:"f08955c39d204c9558718a0808ce2eaf86d48316",
                timestamp:"1492586814",
                url:"http://open.izhuiyou.com/wechat/view/home/AvwvyzchxBDmM"
            }
            wx.config({
...
<style>
    body,html,p,ul,li,a,div,h1,h2,h3{
        margin: 0;
        padding: 0;
    }
    ul,li{
    ...
    body{
        font-family: "PingFang SC",'HanHei SC',"Lantinghei SC","Open Sans",Arial,"Hiragino Sans GB","Microsoft YaHei","\5FAE\8F6F\96C5\9ED1",STHeiti,"WenQuanYi Micro Hei",SimSun,sans-serif;
